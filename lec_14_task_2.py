...
def collision(x1, vx1, x2, vx2, radius1, radius2, mass1, mass2):
...
for k in range(N-1):
    ...
    v10 = sol[1, 1]
    v20 = sol[1, 3]
    res = collision(x10, v10, x20, v20, radius1,  radius2, mass1, mass2)
    v10 = res[0]
    v20 = res[1]
...
ball_1, = plt.plot([], [], 'o', color='b', ms=25)
ball_2, = plt.plot([], [], '|', color='g', ms=300)
